...
def Thermal_Electrical_model(Thermal_Components, T_in_0, T4, T_TESS_0, T_tank_PVT, T_PVT_layers, SoC_0_BESS, T_amb, T_set, G, Tsoil, P_Load, t_final, n_modules = 0, P_BESS_max = 1.28, P_Grid_max = 0, Capacity_BESS = 3.36, PVT_2_TESS = True, HP_2_TESS = True, Network_losses = False, m = 4000, T_sup = 50 + 273, T_TESS_max = 273 + 95, m_dot = 0.22, c_f = 4200, A_PVT = 1.48, dt = 60*15): 
